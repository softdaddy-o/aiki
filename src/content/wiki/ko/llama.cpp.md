...
- [GGUF](/ko/wiki/gguf/) — GGUF와 함께 보면 llama.cpp가 제품, 개념, 모델 가운데 어느 층위인지 비교하기 쉬워.
- [Local LLM](/ko/wiki/local-llm/) — Local LLM와 함께 보면 llama.cpp가 제품, 개념, 모델 가운데 어느 층위인지 비교하기 쉬워.
- [LM Studio](/ko/wiki/lm-studio/) — LM Studio와 비교해 보면 오픈 모델과 로컬 배포에서 어디가 다른지 읽기 쉬워.