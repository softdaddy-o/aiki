  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Vector database (https://en.wikipedia.org/wiki/Vector_database)"
        - "비교 출처 2: What is a Vector Database &amp; How Does it Work? Use Cases + Examples | Pinecone (https://www.pinecone.io/learn/vector-database/)"
    - type: number_verify
      result: pass
