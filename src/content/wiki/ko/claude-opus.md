...
lang: ko
summary: "Claude Opus는 Anthropic이 Claude 안에서 가장 어려운 코딩, 에이전트, 기업 업무를 맡기겠다고 내세우는 상위 모델 라인이야. 기사에서는 점수표보다 어떤 고난도 작업에 최고 티어를 배치하는지 읽는 기준으로 보는 편이 맞아."
...
factCheck:
  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        - "비교 기준: 제품 페이지는 어디에 쓰라고 미는지, 모델 개요 문서는 Claude 안에서 어떤 자리인지 보여 준다는 점을 놓고 비교했어."
...
- **o3 (오쓰리)**: o3도 고난도 문제 해결 티어로 자주 묶여. 같이 보면 추론형 상위 모델이라는 공통점과 각 회사가 실전 사용처를 어떻게 다르게 파는지 비교하기 쉬워.