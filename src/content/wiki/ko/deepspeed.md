  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: deepspeedai/DeepSpeed (https://github.com/deepspeedai/DeepSpeed)"
        - "비교 출처 2: Latest News (https://www.deepspeed.ai/)"
    - type: number_verify
      result: pass
...
## 관련 용어
- [PyTorch](/ko/wiki/pytorch/) — DeepSpeed를 볼 때 비교 포인트는 학습과 비용 최적화 흐름을 어떤 구조로 묶어야 하는지다.
