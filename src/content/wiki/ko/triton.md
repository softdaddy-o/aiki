  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: triton-inference-server/server (https://github.com/triton-inference-server/server)"
        - "비교 출처 2: NVIDIA Dynamo-Triton (https://developer.nvidia.com/triton-inference-server)"
    - type: number_verify
      result: pass
