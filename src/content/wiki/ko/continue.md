  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: continuedev/continue (https://github.com/continuedev/continue)"
        - "비교 출처 2: What is Continue? | Continue Docs (https://docs.continue.dev/)"
    - type: number_verify
      result: pass
