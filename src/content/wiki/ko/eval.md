  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Working with evals | OpenAI API (https://platform.openai.com/docs/guides/evals)"
        - "비교 출처 2: Evaluate on the Hub · Hugging Face (https://huggingface.co/docs/evaluate/index)"
    - type: number_verify
      result: pass
