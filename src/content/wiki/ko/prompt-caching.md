...
lang: ko
summary: "모델 서빙과 추론 성능을 개선하거나 연결하는 AI 기법이야. 보통 정확도, 비용, 실행 방식 중 하나를 바꿔."
...
---
## 한 줄 정의
모델 서빙과 추론 성능을 바꾸거나 개선할 때 쓰는 기법이야. 쉽게 말하면 기존 모델을 더 잘 맞추거나 더 싸게 돌리기 위한 학습·압축 레이어 역할을 한다고 보면 돼.
## 어떻게 작동하나
