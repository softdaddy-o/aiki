  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Retrieval-augmented generation (https://en.wikipedia.org/wiki/Retrieval-augmented_generation)"
        - "비교 출처 2: What is RAG (Retrieval Augmented Generation)? | IBM (https://www.ibm.com/think/topics/retrieval-augmented-generation)"
    - type: number_verify
      result: pass
