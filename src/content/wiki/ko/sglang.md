...
## 관련 용어
- [vLLM](/ko/wiki/vllm/) — SGLang를 볼 때 비교 포인트는 모델 서빙과 추론 성능에서 어떤 도구를 붙여야 하는지다.
- [Triton Inference Server](/ko/wiki/triton/) — SGLang를 볼 때 비교 포인트는 모델 서빙과 추론 성능에서 어떤 도구를 붙여야 하는지다.
- [Ollama](/ko/wiki/ollama/) — SGLang를 볼 때 비교 포인트는 모델 서빙과 추론 성능에서 어떤 도구를 붙여야 하는지다.
