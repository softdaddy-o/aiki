...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "독자 문제 대조: 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지"
        - "용어명 대조: Claude Code"
        - "분류 대조: 도구"
    - type: web_cross_check
      ...
      items:
        - "비교 기준: 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지"
    ...
    - type: number_verify
      result: pass
      summary: "숫자가 적은 항목이라도 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지를 가르는 고유 명칭과 설명 축은 한 번 더 봤다."
      items:
        - "선택 기준 대조: 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지"
        - "명칭 대조: Claude Code"
    ...
    - type: adversarial
      ...
      items:
        - "오해 방지 기준: 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지"
...
## 실제로 무엇을 하나
모델 자체라기보다 개발 생산성과 코딩 워크플로 작업을 실제로 굴리는 도구 쪽에 가까워. 모델 자체를 만드는 게 아니라 코드 작성, 검색, 수정, 실행, 리뷰 같은 반복 작업을 줄여 주는 층이야. 그래서 기능 목록보다 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지가 어떻게 달라지는지로 읽는 편이 이해가 빨라.
## 왜 중요한가
...
## 관련 용어
- [GitHub Copilot](/ko/wiki/copilot/) — Claude Code를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.
- [Cursor](/ko/wiki/cursor/) — Claude Code를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.
- [Aider](/ko/wiki/aider/) — Claude Code를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.
- [Windsurf](/ko/wiki/windsurf/) — Claude Code를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.