...
---
## 한 줄 정의
Tool Use는 LLM이 텍스트 생성만 하지 않고 외부 도구를 불러 결과를 받아 다시 사용하는 실행 패턴이다.
## 어떻게 작동하나
...
## 왜 중요한가
에이전트가 단순 챗봇을 넘어서려면 결국 도구를 써야 한다. Tool Use를 이해하면 "모델 성능"과 "실행 가능한 시스템"을 분리해서 읽을 수 있다.
## 관련 용어
...
- [AutoGen](/ko/wiki/autogen/) — 자동화와 워크플로 설계를 같이 볼 때 도움이 된다.