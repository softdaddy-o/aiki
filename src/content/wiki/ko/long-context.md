...
## 관련 용어
- [Context Window](/ko/wiki/context-window/) — Long Context를 볼 때 비교 포인트는 토큰 예산과 긴 문맥 처리를 기사에서 어떤 판단 기준으로 읽어야 하는지다.
- [Token](/ko/wiki/token/) — Long Context를 볼 때 비교 포인트는 토큰 예산과 긴 문맥 처리를 기사에서 어떤 판단 기준으로 읽어야 하는지다.
- [Memory](/ko/wiki/memory/) — Long Context를 볼 때 비교 포인트는 토큰 예산과 긴 문맥 처리를 기사에서 어떤 판단 기준으로 읽어야 하는지다.