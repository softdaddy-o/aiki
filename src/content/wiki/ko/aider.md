...
title: "Aider"
lang: ko
summary: "Aider를 사용하면 프로그램을 LLM과 페어링하여 새 프로젝트를 시작하거나 기존 코드베이스를 기반으로 구축할 수 있습니다."
...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "독자가 먼저 갈라 봐야 할 건 를 사용하면 프로그램을 LLM과 페어링하여 새 프로젝트를 시작하거나 기존 코드베이스를 기반으로 구축할 수 있습니다."
        - "원문을 보면 를 사용하면 프로그램을 LLM과 페어링하여 새 프로젝트를 시작하거나 기존 코드베이스를 기반으로 구축할 수 있습니다."
    ...
    - type: web_cross_check
      ...
      items:
        - "여기서 먼저 갈라 볼 기준은 터미널의 AI 쌍 프로그래밍입니다."
        - "교차 대조: 터미널의 AI 쌍 프로그래밍입니다."
        - "출처 1 대조: github.com."
        - "출처 2 대조: aider.chat."
    - type: number_verify
      result: pass
...
---
## 한 줄 정의
Aider를 짧게 잡으면 를 사용하면 프로그램을 LLM과 페어링하여 새 프로젝트를 시작하거나 기존 코드베이스를 기반으로 구축할 수 있습니다 쪽이야. 코드베이스를 읽고 파일을 수정하고 CLI 명령을 실행하거나 IDE와 연결하는 흐름에서 존재감이 커.
## 실제로 무엇을 하나
aider는 터미널의 AI 쌍 프로그래밍입니다. 코드베이스를 읽고 파일을 수정하고 CLI 명령을 실행하거나 IDE와 연결하는 흐름에서 존재감이 커. 예를 들어 리포지토리를 탐색하고 파일을 고치고 테스트를 돌리는 코딩 보조 흐름이 여기에 들어가.
## 왜 중요한가
