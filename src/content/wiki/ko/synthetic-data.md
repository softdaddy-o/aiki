  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "같이 본 출처로는 Synthetic data (https://en.wikipedia.org/wiki/Synthetic_data)"
        - "같이 본 출처로는 What Is Synthetic Data? | IBM (https://www.ibm.com/think/topics/synthetic-data)"
    - type: number_verify
      result: pass
      ...
      items:
        ...
        - "이름부터 다시 보면 Synthetic Data로 고정돼."
