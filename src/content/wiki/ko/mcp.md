...
factCheck:
  ...
  checks:
    - type: source_match
      result: pass
      summary: "MCP를 오픈 표준 프로토콜로 읽는 게 맞는지부터 먼저 맞춰봤어."
      items:
    ...
    - type: web_cross_check
      result: pass
      sources: 3
      summary: "소개, 아키텍처, 스펙 문서를 같이 놓고 MCP 범위를 과장하지 않았는지 다시 봤어."
      items:
    ...
    - type: number_verify
      result: pass
      summary: "스펙 버전과 구성 요소 이름처럼 자주 틀리는 고유 항목도 한 번 더 봤어."
      items:
    ...
    - type: adversarial
      result: pass
      summary: "MCP 주변에서 가장 흔한 과장을 어떻게 걸러야 하는지 의심해보고 정리했어."
      items:
