...
## 관련 용어
- [vLLM](/ko/wiki/vllm/) — BentoML를 볼 때 비교 포인트는 모델 서빙과 추론 성능에서 어떤 도구를 붙여야 하는지다.
- [Quantization](/ko/wiki/quantization/) — 추론 서빙과 운영 성능 맥락을 같이 읽게 해 준다.
- [Inference](/ko/wiki/inference/) — 추론 서빙과 운영 성능 맥락을 같이 읽게 해 준다.
- [ONNX](/ko/wiki/onnx/) — 추론 서빙과 운영 성능 맥락을 같이 읽게 해 준다.