  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "같이 본 출처로는 bentoml/BentoML (https://github.com/bentoml/BentoML)"
        - "같이 본 출처로는 Bento: Run Inference at Scale (https://www.bentoml.com/)"
    - type: number_verify
      result: pass
...
## 관련 용어
- [vLLM](/ko/wiki/vllm/) — BentoML를 볼 때 비교 포인트는 모델 서빙과 추론 성능에서 어떤 도구를 붙여야 하는지다. - [Quantization](/ko/wiki/quantization/) — 추론 서빙과 운영 성능 맥락을 같이 읽는 데 도움이 돼. - [Inference](/ko/wiki/inference/) — 추론 서빙과 운영 성능 맥락을 같이 읽는 데 도움이 돼. - [ONNX](/ko/wiki/onnx/) — 추론 서빙과 운영 성능 맥락을 같이 읽는 데 도움이 돼.