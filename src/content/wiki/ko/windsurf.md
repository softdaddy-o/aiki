  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Windsurf - The best AI for Coding (https://windsurf.com/)"
        - "비교 출처 2: Welcome to Windsurf - Windsurf Docs (https://docs.windsurf.com/)"
    - type: number_verify
      result: pass
...
## 관련 용어
- [Cursor](/ko/wiki/cursor/) — Windsurf를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.
- [Continue](/ko/wiki/continue/) — Windsurf를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.
- [Claude Code](/ko/wiki/claude-code/) — Windsurf를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.
- [GitHub Copilot](/ko/wiki/copilot/) — Windsurf를 볼 때 비교 포인트는 개발 생산성과 코딩 워크플로에서 어떤 도구를 붙여야 하는지다.