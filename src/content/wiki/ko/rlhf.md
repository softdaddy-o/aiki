...
- [Fine-tuning](/ko/wiki/fine-tuning/) — RLHF를 볼 때 비교 포인트는 학습과 비용 최적화를 정확도, 비용, 실행 흐름 중 어디서 바꿔야 하는지다.
- [Distillation](/ko/wiki/distillation/) — RLHF를 볼 때 비교 포인트는 학습과 비용 최적화를 정확도, 비용, 실행 흐름 중 어디서 바꿔야 하는지다.