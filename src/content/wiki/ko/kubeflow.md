  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "같이 본 출처로는 kubeflow/kubeflow (https://github.com/kubeflow/kubeflow)"
        - "같이 본 출처로는 Kubeflow (https://www.kubeflow.org/)"
    - type: number_verify
      result: pass
...
## 관련 용어
- [Weights & Biases](/ko/wiki/weights-and-biases/) — 운영과 배포 관점에서 같이 보면 맥락이 선다. - [MLflow](/ko/wiki/mlflow/) — 운영과 배포 관점에서 같이 보면 맥락이 선다.