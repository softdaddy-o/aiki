...
---
## 한 줄 정의
Claude라는 이름을 새 모델 하나라고 읽으면 자꾸 헷갈려. Anthropic가 범용 대화형 모델 라인업 쪽 라인업을 설명할 때 앞에 내세우는 간판에 가깝거든. 그래서 기사에서 이 계열명이 보이면 벤치마크보다 어떤 사용 장면을 키우려는지부터 읽는 편이 덜 틀려.
## 이 모델로 무엇을 할 수 있나
...
## 같이 보면 좋은 모델
- [Claude Opus](/ko/wiki/claude-opus/) — Claude Opus와는 추론형 모델인지 범용 생성형 모델인지 비교하기 쉬워.
