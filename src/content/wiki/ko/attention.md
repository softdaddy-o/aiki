  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Attention (machine learning) (https://en.wikipedia.org/wiki/Attention_(machine_learning))"
        - "비교 출처 2: Attention is All You Need (https://research.google/pubs/attention-is-all-you-need/)"
    - type: number_verify
      result: pass
...
## 관련 용어
- [Transformer](/ko/wiki/transformer/) — Attention를 볼 때 비교 포인트는 모델 내부 구조와 효율를 기사에서 어떤 판단 기준으로 읽어야 하는지다.
- [Mixture of Experts](/ko/wiki/mixture-of-experts/) — Attention를 볼 때 비교 포인트는 모델 내부 구조와 효율를 기사에서 어떤 판단 기준으로 읽어야 하는지다.