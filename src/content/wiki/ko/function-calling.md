  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Function calling | OpenAI API (https://platform.openai.com/docs/guides/function-calling)"
        - "비교 출처 2: Tool use with Claude (https://docs.anthropic.com/en/docs/agents-and-tools/tool-use/overview)"
    - type: number_verify
      result: pass
