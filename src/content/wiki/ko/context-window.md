  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "같이 본 출처로는 Large language model - Wikipedia (https://en.wikipedia.org/wiki/Large_language_model)"
...
## 관련 용어
- [Token](/ko/wiki/token/) — 컨텍스트 길이를 계산하는 기본 단위 - [Tokenizer](/ko/wiki/tokenizer/) — 문장을 토큰으로 자르는 규칙 - [Long Context](/ko/wiki/long-context/) — 긴 입력 처리 경쟁을 설명할 때 같이 나오는 개념