  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Large language model - Wikipedia (https://en.wikipedia.org/wiki/Large_language_model)"
        - "비교 출처 2: Context windows (https://docs.anthropic.com/en/docs/build-with-claude/context-windows)"
    - type: number_verify
      result: pass
