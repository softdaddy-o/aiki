...
## 같이 보면 좋은 모델
- [GPT-4o](/ko/wiki/gpt-4o/): 이미지를 이해하고 생성 맥락까지 묶어서 보는 데 좋아. DALL-E보다 더 넓은 멀티모달 제품 흐름을 같이 읽게 해.
- `FLUX.1`: 고품질 이미지 생성과 로컬 워크플로 쪽에서 자주 비교돼. API 중심인 DALL-E와 배포 방식 차이를 보기 좋아.
- [Stable Diffusion](/ko/wiki/stable-diffusion/): 오픈 생태계 대표축이야. DALL-E와 비교하면 클라우드 제품 중심과 로컬 커뮤니티 중심의 차이가 선명해져.
