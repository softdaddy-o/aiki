...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "독자 문제 대조: 경량 모델과 온디바이스 추론를 기사에서 어떤 판단 기준으로 읽어야 하는지."
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: https://azure.microsoft.com/en-us/resources/cloud-computing-dictionary/what-is-a-small-language-model (https://azure.microsoft.com/en-us/resources/cloud-computing-dictionary/what-is-a-small-language-model)"
        - "비교 출처 2: SmolLM - blazingly fast and remarkably powerful (https://huggingface.co/blog/smollm)"
    - type: number_verify
      result: pass
