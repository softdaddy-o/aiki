  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "계층화된 LLM 아키텍처를 위한 비동기식 검증된 의미론적 캐싱"이고, 원문 제목은 "Asynchronous Verified Semantic Caching for Tiered LLM Architectures"로 잡혔어.
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 cs.AI (https://arxiv.org/abs/2602.13165v1)
        - 같이 본 출처로는 Secondary source (https://arxiv.org/abs/2602.13110v1)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 2602.13165v1 쪽이야.
