  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"AI가 영국에서 유방암 탐지를 개선하는 방법\"이고, 원문 제목은 \"How AI can improve breast cancer detection in the UK\"로 잡혔어."
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: blog.google (https://blog.google/innovation-and-ai/technology/health/google-ai-breast-cancer-detection/)"
        - "비교 출처 2: Secondary source (https://arxiv.org/abs/2603.13191v1)"
    - type: number_verify
      result: pass
