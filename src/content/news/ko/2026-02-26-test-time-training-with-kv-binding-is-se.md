  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "KV 바인딩을 사용한 테스트 시간 훈련은 비밀리에 선형 주의를 기울입니다."이고, 원문 제목은 "Test-Time Training with KV Binding Is Secretly Linear Attention"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 arxiv.org로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 rag, claude-code, embedding, attention로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 cs.AI (https://arxiv.org/abs/2602.21204v1)
        - 같이 본 출처로는 Secondary source (https://arxiv.org/abs/2602.21189v1)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 2602.21204v1, 2602.21204v 쪽이야.
