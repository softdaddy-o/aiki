  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "비밀 지식 추출을 위한 자연스러운 테스트베드로서의 검열된 LLM"이고, 원문 제목은 "Censored LLMs as a Natural Testbed for Secret Knowledge Elicitation"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 arxiv.org로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 llm, speech-to-text, vllm, qwen로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 cs.AI (https://arxiv.org/abs/2603.05494v1)
        - 같이 본 출처로는 Secondary source (https://arxiv.org/abs/2603.05485v1)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 2603.05494v1 쪽이야.
