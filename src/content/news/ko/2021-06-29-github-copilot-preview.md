  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "GitHub Copilot 공개, AI 코딩 보조의 시작"이고, 원문 제목은 "GitHub Copilot"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 github.blog로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 copilot, coding-agent, github로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 GitHub Copilot (https://github.blog/news-insights/product-news/github-copilot-your-ai-pair-programmer/)
        - 같이 본 출처로는 Secondary source (https://en.wikipedia.org/wiki/GitHub_Copilot)
    - type: number_verify
      result: pass
