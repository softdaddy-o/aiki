  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"세밀한 세부 타겟팅을 통해 블랙박스 LVLM 공격의 한계를 뛰어넘다\"이고, 원문 제목은 \"Pushing the Frontier of Black-Box LVLM Attacks via Fine-Grained Detail Targeting\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 arxiv.org로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 multimodal, alignment, vision-language-model, modal로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: cs.AI (https://arxiv.org/abs/2602.17645v1)"
        - "비교 출처 2: Secondary source (https://arxiv.org/abs/2602.17594v1)"
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - "숫자 포인트: 원문에서 다시 본 숫자나 버전 표기는 2602.17645v1 쪽이야."
