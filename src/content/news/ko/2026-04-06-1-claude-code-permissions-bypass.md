...
readerValue: "이 글이 해결해주는 문제는 Anthropic의 AI 코딩 도구 Claude Code에서 명령어가 50개를 넘으면 사용자가 설정한 deny 규칙을 건너뛰는 취약점이 발견됐다. 보안 회사 Adversa AI가 npm 소스맵 유출 후 분석해 밝혀냈고, v2.1.90에서 패치됐다가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준다는 점이다."
