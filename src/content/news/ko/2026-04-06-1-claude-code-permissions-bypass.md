  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "Claude Code, 명령어 50개 넘으면 보안 규칙 무시하는 버그 발견"이고, 원문 제목은 "Adversa AI"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 adversa.ai로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 claude-code, 보안, anthropic, 취약점로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 Adversa AI 분석 보고서 (https://adversa.ai/claude-code-security-bypass-deny-rules-disabled/)
        - 같이 본 출처로는 The Register 보도 (https://www.theregister.com/2026/04/01/claude_code_rule_cap_raises/)
        - 같이 본 출처로는 SecurityWeek 보도 (https://www.securityweek.com/critical-vulnerability-in-claude-code-emerges-days-after-source-leak/)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 50, v2.1.90, 3, 31 쪽이야.
