...
readerValue: "이 가이드는 다음을 포함한 최신 Sora API 기능을 반영하도록 업데이트되었습니다가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준다는 점이다."
...
Sora API 기능을 반영하도록 업데이트되었습니다 [원문](https://cookbook.openai.com/examples/sora/sora2_prompting_guide)은 Sora 2 Prompting Guide 기준으로 확인한 내용이야. 이 이슈는 Sora API 기능을 반영하도록 업데이트되었습니다가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준 쪽에서 읽어야 맥락이 빨리 잡혀.
