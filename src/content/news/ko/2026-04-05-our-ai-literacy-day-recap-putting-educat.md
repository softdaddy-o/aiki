...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "기사 제목 대조: AI 문해력의 날 요약: 교육자를 선두에 두기"
        - "원문 제목 대조: Our AI Literacy Day recap: putting educators in the lead"
    ...
    - type: web_cross_check
      ...
      items:
        - "출처 1: blog.google (https://blog.google/products-and-platforms/products/education/ai-literacy-tools-certifications/)"
    - type: number_verify
      result: pass
...
Google에서 주최한 뉴욕시 공립학교 이벤트와 Google AI 활용 리소스 업데이트를 포함한 AI 활용 능력의 날 요약입니다 [원문](https://blog.google/products-and-platforms/products/education/ai-literacy-tools-certifications/)은 Our AI Literacy Day recap: putting educators in the lead 기준으로 확인한 내용이야. 이 이슈는 Google에서 주최한 뉴욕시 공립학교 이벤트와 Google AI 활용 리소스 업데이트를 포함한 AI 활용 능력의 날 요약입니다가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준 쪽에서 읽어야 맥락이 빨리 잡혀.

AI 문해력의 날 요약: 교육자를 선두에 두기, Google에서 주최한 뉴욕시 공립학교 이벤트와 Google AI…에서 진짜 봐야 하는 건 이름 자체보다 실무 우선순위와 적용 범위가 어디를 바꾸는지야. 공개 범위, 숫자, 적용 대상, 제약 조건이 같이 움직이는지 봐야 발표 문구와 실전 신호를 구분할 수 있어.
