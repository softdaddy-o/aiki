  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 google, gemini, deepmind, lyria로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 Google Blog — Use Lyria 3 to create music tracks in the Gemini app (https://blog.google/innovation-and-ai/products/gemini-app/lyria-3/)
