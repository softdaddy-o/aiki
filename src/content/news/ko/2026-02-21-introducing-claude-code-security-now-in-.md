  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"방어자에게 최첨단 사이버 보안 기능 제공\"이고, 원문 제목은 \"Making frontier cybersecurity capabilities available to defenders\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 anthropic.com로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 claude-code, claude로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: ClaudeAI (https://www.anthropic.com/news/claude-code-security)"
        - "비교 출처 2: Secondary source (https://v.redd.it/erbjjmryhpkg1)"
    - type: number_verify
      result: pass
