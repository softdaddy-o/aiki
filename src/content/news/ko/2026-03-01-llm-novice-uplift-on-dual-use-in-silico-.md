  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "이중 용도, In Silico 생물학 작업에 대한 LLM 초보자 향상"이고, 원문 제목은 "LLM Novice Uplift on Dual-Use, In Silico Biology Tasks"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 arxiv.org로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 llm, benchmark로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 cs.AI (https://arxiv.org/abs/2602.23329v1)
        - 같이 본 출처로는 Secondary source (https://arxiv.org/abs/2602.23163v1)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 2602.23329v1 쪽이야.
