...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "기사 제목 대조: FlashOptim: 메모리 효율적인 교육을 위한 최적화 프로그램"
        - "원문 제목 대조: FlashOptim: Optimizers for Memory Efficient Training"
        - "대표 출처 도메인: arxiv.org"
        - "핵심 태그 축: memory"
    - type: web_cross_check
      ...
      items:
        - "출처 1: cs.AI (https://arxiv.org/abs/2602.23349v1)"
        - "출처 2: Secondary source (https://arxiv.org/abs/2602.23335v1)"
    - type: number_verify
      result: pass
      summary: 숫자와 고유 명칭은 별도 묶음으로 다시 훑어 과장 여부를 걸렀다.
      items:
        - "수치 대조: arXiv 문서 2602.23349v1의 요약 페이지: FlashOptim: 메모리 효율적인 교육을 위한 최적화 도구."
        - "수치 대조: arXiv 문서 2602.23349v1의 요약 페이지: FlashOptim: 메모리 효율적인 교육을 위한 최적화 도구 [원문](https://arxiv.org/abs/2602.23349v1)은..."
        - "수치 대조: 이 이슈는 arXiv 문서 2602.23349v1의 요약 페이지: FlashOptim: 메모리 효율적인 교육을 위한 최적화 도구가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준 ..."
        - "수치 대조: FlashOptim: 메모리 효율적인 교육을 위한 최적화 프로그램, arXiv 문서 2602.23349v1의 요약…에서 진짜 봐야 하는 건 이름 자체보다 실무 우선순위와 적용 범위가 어디를 바..."
    - type: adversarial
      result: pass
