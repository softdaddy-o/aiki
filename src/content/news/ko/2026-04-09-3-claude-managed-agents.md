  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"몇 달이 며칠로 — Claude Managed Agents 퍼블릭 베타\"이고, 원문 제목은 \"The New Stack: Claude Managed Agents\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 thenewstack.io로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 Anthropic, AI에이전트, Claude, 엔터프라이즈로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: The New Stack (https://thenewstack.io/with-claude-managed-agents-anthropic-wants-to-run-your-ai-agents-for-you/)"
        - "비교 출처 2: Wired (https://www.wired.com/story/anthropic-launches-claude-managed-agents/)"
        - "비교 출처 3: AI News (https://blockchain.news/ainews/claude-managed-agents-public-beta-build-and-deploy-ai-agents-at-scale-in-days-feature-breakdown-and-business-impact)"
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - "숫자 포인트: 원문에서 다시 본 숫자나 버전 표기는 4, 8 쪽이야."
    - type: adversarial
      result: pass
