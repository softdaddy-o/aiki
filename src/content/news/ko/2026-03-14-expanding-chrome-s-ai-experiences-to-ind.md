  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Chrome의 AI 경험을 인도, 뉴질랜드, 캐나다로 확장\"이고, 원문 제목은 \"Expanding Chrome’s AI experiences to India, New Zealand and Canada\"로 잡혔어."
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: blog.google (https://blog.google/products-and-platforms/products/chrome/chrome-expands-india-new-zealand-canada/)"
        - "비교 출처 2: Secondary source (https://blog.google/innovation-and-ai/technology/health/google-ai-breast-cancer-detection/)"
    - type: number_verify
      result: pass
