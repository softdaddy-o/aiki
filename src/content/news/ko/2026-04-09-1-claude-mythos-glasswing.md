  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "공개 거부된 AI — Claude Mythos와 Project Glasswing"이고, 원문 제목은 "Anthropic Project Glasswing"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 anthropic.com로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 Anthropic, AI보안, 사이버보안, Claude로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 Anthropic Project Glasswing (https://www.anthropic.com/glasswing)
        - "같이 본 출처로는 TechCrunch: Anthropic Mythos (https://techcrunch.com/2026/04/07/anthropic-mythos-ai-model-preview-security/)"
        - 같이 본 출처로는 The Guardian (https://www.theguardian.com/technology/2026/apr/08/anthropic-ai-cybersecurity-software)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 11, 17, 27 쪽이야.
    - type: adversarial
      result: pass
...
reviewStamp:
  ...
  guideVersions:
    ...
    news: "3.1.2"
  panelVerdict: pass
  contentHash: "77c1caa359e2bd3f"
  reviewedAt: "2026-04-25T09:55:59Z"
---
## 무슨 일이 있었나

[Anthropic](/ko/wiki/anthropic/)이 새 모델 [Claude Mythos Preview](https://www.anthropic.com/glasswing)를 공개했는데, 일반 사용자는 쓸 수 없어. 몇 주 만에 FreeBSD에서 17년 된 원격코드실행 취약점(CVE-2026-4747), OpenBSD에서는 무려 27년 된 버그를 포함해 수천 개의 제로데이를 혼자 찾아냈거든. "너무 강해서 악용될 수 있다"는 판단에 일반 공개를 포기하고, [Project Glasswing](https://www.anthropic.com/glasswing)이라는 파트너십 프로그램으로만 운영하기로 했다.

## 왜 중요할까

파트너사는 AWS, Apple, Broadcom, Cisco, CrowdStrike, Google, JPMorgan Chase, Linux Foundation, Microsoft, NVIDIA, Palo Alto Networks — 총 11곳이야. 이들이 Mythos로 방어를 먼저 점검하는 동안 [Anthropic](/ko/wiki/anthropic/)은 공격자보다 앞서 패치할 시간을 버는 구조거든.
