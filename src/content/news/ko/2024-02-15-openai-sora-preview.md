  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Sora 공개, 생성형 비디오 경쟁의 개막\"이고, 원문 제목은 \"OpenAI Sora\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 openai.com로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 sora, video-generation, openai로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: OpenAI Sora (https://openai.com/index/sora/)"
        - "비교 출처 2: Secondary source (https://en.wikipedia.org/wiki/Sora_(text-to-video_model))"
    - type: number_verify
      result: pass
