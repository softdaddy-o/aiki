...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "기사 제목 대조: Sora 공개, 생성형 비디오 경쟁의 개막"
        - "원문 제목 대조: OpenAI Sora"
        - "대표 출처 도메인: openai.com"
        - "핵심 태그 축: sora, video-generation, openai"
    - type: web_cross_check
      result: pass
      sources: 2
      summary: 출처 2건을 나란히 놓고 정말 같은 사건을 말하는지 다시 봤다.
      items:
        - "출처 1: OpenAI Sora (https://openai.com/index/sora/)"
        - "출처 2: Secondary source (https://en.wikipedia.org/wiki/Sora_(text-to-video_model))"
    - type: number_verify
      result: pass
