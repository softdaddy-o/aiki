  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"mistralai/Leanstral-2603\"이고, 원문 제목은 \"mistralai/Leanstral-2603 · Hugging Face\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 huggingface.co로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 rag, agent, multimodal, modal로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: LocalLLaMA (https://huggingface.co/mistralai/Leanstral-2603)"
