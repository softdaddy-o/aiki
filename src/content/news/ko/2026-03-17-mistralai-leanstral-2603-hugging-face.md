  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "mistralai/Leanstral-2603"이고, 원문 제목은 "mistralai/Leanstral-2603 · Hugging Face"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 huggingface.co로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 rag, agent, multimodal, modal로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 LocalLLaMA (https://huggingface.co/mistralai/Leanstral-2603)
...
[원문](https://huggingface.co/mistralai/Leanstral-2603)은 mistralai/Leanstral-2603 · [Hugging Face](/ko/wiki/hugging-face/) 기준으로 확인한 내용이야. 이 이슈는 이 변화가 어디에 직접 영향을 주는지 빠르게 구분하는 거야 쪽에서 읽어야 맥락이 빨리 잡혀.
