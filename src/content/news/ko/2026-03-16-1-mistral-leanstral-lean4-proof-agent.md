  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Leanstral: 신뢰할 수 있는 바이브 코딩을 위한 오픈 소스 기반\"이고, 원문 제목은 \"Leanstral: Open-Source foundation for trustworthy vibe-coding\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 mistral.ai로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 mistral, lean4, open-source, formal-verification로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Leanstral: Open-Source foundation for trustworthy vibe-coding | Mistral AI (https://mistral.ai/news/leanstral)"
        - "비교 출처 2: mistralai/Leanstral-2603 · Hugging Face (https://huggingface.co/mistralai/Leanstral-2603)"
        - "비교 출처 3: Leanstral - Mistral AI Docs (https://docs.mistral.ai/models/leanstral-26-03)"
    - type: number_verify
      result: pass
