  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "산업 공정 자동화를 위한 LLM 활용"이고, 원문 제목은 "Utilizing LLMs for Industrial Process Automation"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 arxiv.org로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 llm로 읽었어.
...
arXiv 논문 2602.23331v1의 요약 페이지: 산업 공정 자동화를 위한 LLM 활용 [원문](https://arxiv.org/abs/2602.23331v1)은 Utilizing [LLMs](/ko/wiki/llm/) for Industrial Process Automation 기준으로 확인한 내용이야. 이 이슈는 arXiv 논문 2602.23331v1의 요약 페이지: 산업 공정 자동화를 위한 LLM 활용가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준 쪽에서 읽어야 맥락이 빨리 잡혀.
