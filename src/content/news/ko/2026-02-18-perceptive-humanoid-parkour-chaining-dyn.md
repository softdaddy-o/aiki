  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목부터 다시 보면 기사 제목은 \"지각형 휴머노이드 파쿠르: 모션 매칭을 통해 역동적인 인간 기술 연결\"이고, 원문 제목은 \"Perceptive Humanoid Parkour: Chaining Dynamic Human Skills via Motion Matching\"로 잡혔어."
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 cs.AI (https://arxiv.org/abs/2602.15827v1)
        - 같이 본 출처로는 Secondary source (https://arxiv.org/abs/2602.15816v1)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 검증해뒀어.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 2602.15827v1 쪽이야.
