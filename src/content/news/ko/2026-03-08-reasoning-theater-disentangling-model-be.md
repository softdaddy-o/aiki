  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목부터 다시 보면 기사 제목은 \"추론 극장: 사고의 사슬에서 모델의 신념을 분리\"이고, 원문 제목은 \"Reasoning Theater: Disentangling Model Beliefs from Chain-of-Thought\"로 잡혔어."
        - 출처를 다시 보면 대표 원문 도메인은 arxiv.org로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 reasoning, chain-of-thought로 읽었어.
