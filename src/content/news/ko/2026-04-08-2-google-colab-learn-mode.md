  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Colab이 코딩 과외 선생님이 됐다 — Learn Mode 출시\"이고, 원문 제목은 \"Google Blog: Colab Learn Mode\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 blog.google로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 Google, Colab, Gemini, AI코딩교육로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Google Blog: Colab Updates (https://blog.google/innovation-and-ai/technology/developers-tools/colab-updates/)"
    - type: number_verify
      result: pass
