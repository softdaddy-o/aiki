  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Gemini가 내 이메일을 학습하지 않는다 — Google의 해명\"이고, 원문 제목은 \"Google Blog: Gmail Privacy with Gemini\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 blog.google로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 Google, Gmail, Gemini, AI프라이버시로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Google Blog (https://blog.google/products-and-platforms/products/gmail/privacy-in-gmail-with-gemini/)"
        - "비교 출처 2: BetaNews (https://betanews.com/article/google-insists-it-does-not-train-gemini-with-your-emails/)"
    - type: number_verify
      result: pass
