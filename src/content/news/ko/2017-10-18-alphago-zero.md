  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "AlphaGo Zero, 자기학습 강화학습의 분기점"이고, 원문 제목은 "AlphaGo Zero"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 deepmind.google로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 alphago-zero, deepmind, reinforcement-learning로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 AlphaGo Zero (https://deepmind.google/blog/alphago-zero-starting-from-scratch/)
        - 같이 본 출처로는 Secondary source (https://en.wikipedia.org/wiki/AlphaGo_Zero)
    - type: number_verify
      result: pass
