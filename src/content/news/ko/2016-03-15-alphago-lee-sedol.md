  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"AlphaGo, AI 경쟁의 기준을 바꾼 대국\"이고, 원문 제목은 \"AlphaGo\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 deepmind.google로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 alphago, deepmind, reinforcement-learning로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: AlphaGo (https://deepmind.google/research/highlighted-research/alphago/the-future-of-go-summit)"
        - "비교 출처 2: Secondary source (https://en.wikipedia.org/wiki/AlphaGo_versus_Lee_Sedol)"
    - type: number_verify
      result: pass
