...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "기사 제목 대조: 확산 언어 모델을 위한 싱크 인식 가지치기"
        - "원문 제목 대조: Sink-Aware Pruning for Diffusion Language Models"
        - "대표 출처 도메인: arxiv.org"
        - "핵심 태그 축: llm, token, attention, diffusion"
    - type: web_cross_check
      result: pass
      sources: 2
      summary: 출처 2건을 비교해 같은 사건을 가리키는지 교차검증했다.
      items:
        - "출처 1: cs.AI (https://arxiv.org/abs/2602.17664v1)"
        - "출처 2: Secondary source (https://arxiv.org/abs/2602.17602v1)"
    - type: number_verify
      result: pass
      summary: 숫자와 고유 명칭은 별도 묶음으로 다시 훑어 과장 여부를 걸렀다.
      items:
        - "수치 대조: arXiv 논문 2602.17664v1의 요약 페이지: 확산 언어 모델을 위한 싱크 인식 가지치기."
        - "수치 대조: arXiv 논문 2602.17664v1의 요약 페이지: 확산 언어 모델을 위한 싱크 인식 가지치기 [원문](https://arxiv.org/abs/2602.17664v1)은 Sink-Aware..."
        - "수치 대조: 이 이슈는 arXiv 논문 2602.17664v1의 요약 페이지: 확산 언어 모델을 위한 싱크 인식 가지치기가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준 쪽에서 읽어야 맥락이..."
        - "수치 대조: arXiv 논문 2602.17664v1의 요약 페이지: 확산 언어 모…에서 진짜 봐야 하는 건 이름 자체보다 실무 우선순위와 적용 범위가 어디를 바꾸는지야."
    - type: adversarial
      result: pass
