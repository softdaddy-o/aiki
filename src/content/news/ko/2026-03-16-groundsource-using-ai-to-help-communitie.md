  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Groundsource: AI를 사용하여 지역 사회가 자연 재해를 더 잘 예측할 수 있도록 지원\"이고, 원문 제목은 \"Groundsource: using AI to help communities better predict natural disasters\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 blog.google로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 agent, memory로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: blog.google (https://blog.google/innovation-and-ai/technology/research/gemini-help-communities-predict-crisis/)"
        - "비교 출처 2: Secondary source (https://blog.google/products/ads-commerce/bidding-and-budgeting-with-ai/)"
    - type: number_verify
      result: pass
