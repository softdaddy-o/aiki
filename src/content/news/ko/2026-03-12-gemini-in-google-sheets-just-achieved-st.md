...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "기사 제목 대조: Google Sheets의 Gemini가 방금 최고 수준의 성능을 달성했습니다."
        - "원문 제목 대조: Gemini in Google Sheets just achieved state-of-the-art performance."
        - "대표 출처 도메인: blog.google"
        - "핵심 태그 축: claude-code, gemini, claude"
    - type: web_cross_check
      result: pass
      sources: 2
      summary: 출처 2건을 나란히 놓고 정말 같은 사건을 말하는지 다시 봤다.
      items:
        - "출처 1: blog.google (https://blog.google/products-and-platforms/products/workspace/gemini-google-sheets-state-of-the-art/)"
        - "출처 2: Secondary source (https://blog.google/products-and-platforms/products/workspace/gemini-workspace-updates-march-2026/)"
    - type: number_verify
      result: pass
