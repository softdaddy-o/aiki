...
factCheck:
  ...
  checks:
    - type: source_match
      result: pass
      summary: arXiv 논문 원문 대조 확인
      items:
        - "236 occupations — 논문 제목·요약에 명시 ✅"
        - "5 US metros (SF Bay, Seattle, Austin, Boston, NYC) — 논문 요약 확인 ✅"
        - "Acemoglu-Restrepo 프레임워크 확장 — 논문 TL;DR 확인 ✅"
    - type: web_cross_check
      result: pass
      sources: 2
      summary: arXiv, MIT Technology Review 교차검증
      items:
        - "arXiv: 원문 직접 확인"
        - "MIT Technology Review: 에이전트형 AI 워크플로우 관련 맥락 확인"
    - type: number_verify
      result: pass
      summary: 수치 확인
      items:
        - "236개 직종 — 논문 제목에 명시 ✅"
        - "5개 도시 — SF Bay, Seattle, Austin, Boston, NYC 확인 ✅"
    - type: adversarial
      result: pass
      summary: 과장·인과 오류 검토
      items:
        - "미국 5개 기술 도시 중심 분석으로 한국 등 다른 지역에 그대로 적용하기 어려울 수 있음"
        - "예측 모델이므로 실제 대체 속도는 다를 수 있음"
      findings:
        - "미국 5개 기술 도시 중심 분석 — 다른 지역 적용 시 주의 필요"
score: 82
tags: ["AI고용", "직업대체", "에이전트AI", "연구"]
---
