  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"Gemini API에 Flex/Priority 티어 추가 — 비용 50% 절감 or 최우선 처리\"이고, 원문 제목은 \"Google Blog\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 blog.google로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 gemini, google, api, pricing로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: Google Blog — Flex and Priority tiers (https://blog.google/innovation-and-ai/technology/developers-tools/introducing-flex-and-priority-inference/)"
        - "비교 출처 2: Gemini API Priority Inference Docs (https://ai.google.dev/gemini-api/docs/priority-inference)"
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - "숫자 포인트: 원문에서 다시 본 숫자나 버전 표기는 50%, 4, 2, 3 쪽이야."
    - type: adversarial
      result: pass
