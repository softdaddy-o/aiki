...
readerValue: "이 글이 해결해주는 문제는 OpenAI가 'Intelligence Age를 위한 산업 정책'을 발표했어. 공공 자산 펀드, 사회 안전망 강화, AI 경제 특구 등 3가지 정책 제안이 핵심이야. 일자리 자동화를 공개 인정하면서 뉴딜 수준의 새로운 사회 계약이 필요하다는 주장가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하게 해준다는 점이다."
...
factCheck:
  ...
  checks:
    ...
    - type: adversarial
      result: pass
      findings:
        - "Sam Altman의 'New Deal' 발언은 문서 본문이 아닌 Axios 인터뷰 출처"
        - "AI 경제 구역은 개념만 제시, 구체적 구역 수는 문서에 명시 없음 (원문 수정 완료)"
