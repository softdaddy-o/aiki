  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"자율 경주에서 순수 추격을 조정하는 방법 학습: PPO를 통한 공동 예측 및 조향 이득 제어\"이고, 원문 제목은 \"Learning to Tune Pure Pursuit in Autonomous Racing: Joint Lookahead and Steering-Gain Control with PPO\"로 잡혔어."
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: cs.AI (https://arxiv.org/abs/2602.18386v1)"
        - "비교 출처 2: Secondary source (https://arxiv.org/abs/2602.18297v1)"
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - "숫자 포인트: 원문에서 다시 본 숫자나 버전 표기는 2602.18386v1, 2 쪽이야."
