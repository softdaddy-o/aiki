  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"오픈 소스 AI 모델 SpeciesNet이 야생 동물 보호를 촉진하는 데 어떻게 도움이 되는지\"이고, 원문 제목은 \"How our open-source AI model SpeciesNet is helping to promote wildlife conservation\"로 잡혔어."
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: blog.google (https://blog.google/company-news/outreach-and-initiatives/sustainability/speciesnet-open-source-ai-wildlife/)"
        - "비교 출처 2: Secondary source (https://arxiv.org/abs/2603.12246v1)"
    - type: number_verify
      result: pass
