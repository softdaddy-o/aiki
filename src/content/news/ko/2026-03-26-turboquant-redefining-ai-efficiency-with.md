  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"TurboQuant: 극도의 압축으로 AI 효율성 재정의\"이고, 원문 제목은 \"TurboQuant: Redefining AI efficiency with extreme compression\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 research.google로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 quantization, memory로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: artificial (https://research.google/blog/turboquant-redefining-ai-efficiency-with-extreme-compression/)"
        - "비교 출처 2: Secondary source (https://arxiv.org/abs/2603.23485v1)"
    - type: number_verify
      result: pass
