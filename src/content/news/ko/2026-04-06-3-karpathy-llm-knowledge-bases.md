...
readerValue: "이 뉴스의 값은 Andrej Karpathy가 GitHub Gist에 'LLM Knowledge Bases'를 공개했다. RAG나 벡터 DB 없이, LLM이 원본 문서를 마크다운 위키로 컴파일하고 Obsidian으로 탐색하는 구조다. 기사 100개, 40만 단어 규모에서 복잡한 Q&A가 가능하다고 한다가 실제 시장과 개발 흐름에 어떤 신호인지 빠르게 판단하게 해준다는 점이다."
