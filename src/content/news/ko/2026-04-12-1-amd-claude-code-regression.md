...
Laurenzo 팀은 이미 다른 코딩 도구로 전환했어. [GitHub issue #42796](https://github.com/anthropics/claude-code/issues/42796)에는 87개 넘는 댓글이 달렸는데, 비슷한 경험을 보고하는 엔터프라이즈 사용자가 많아. Anthropic 쪽 공식 대응은 아직 없어. Claude Code를 실무에 쓰고 있다면 최근 세션 품질을 직접 체크해보는 게 좋겠어.
