  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "ChatGPT 출시, 대화형 AI 대중화의 출발점"이고, 원문 제목은 "ChatGPT"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 openai.com로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 chatgpt, openai, assistant로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 ChatGPT (https://openai.com/index/chatgpt/)
        - 같이 본 출처로는 Secondary source (https://en.wikipedia.org/wiki/ChatGPT)
    - type: number_verify
      result: pass
