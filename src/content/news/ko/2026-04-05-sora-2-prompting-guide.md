  ...
  checks:
    ...
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 developers.openai.com (https://developers.openai.com/cookbook/examples/sora/sora2_prompting_guide/)
        - 같이 본 출처로는 Related OpenAI guide (https://developers.openai.com/cookbook/examples/gpt-5/codex_prompting_guide/)
    - type: number_verify
      result: pass
