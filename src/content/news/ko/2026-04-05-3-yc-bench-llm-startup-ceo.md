...
12개 모델 중 평균 최종 자금 100만 달러를 넘긴 건 딱 3개뿐이야. [Claude Opus 4.6](/ko/wiki/claude-opus-4-6/)이 평균 127만 달러로 1위, [GLM-5](/ko/wiki/glm-5/)가 121만 달러로 바로 뒤를 쫓았어. 재밌는 건 [GLM-5](/ko/wiki/glm-5/)의 [추론](/ko/wiki/inference/) 비용이 [Claude Opus 4.6](/ko/wiki/claude-opus-4-6/)의 11분의 1이라는 거야. 비용 대비 성과로 따지면 [GLM-5](/ko/wiki/glm-5/)가 사실상 최고 효율이야.
