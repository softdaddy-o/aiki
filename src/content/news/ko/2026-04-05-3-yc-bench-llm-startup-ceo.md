  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"YC-Bench — LLM에게 스타트업 1년 경영을 맡겨봤어\"이고, 원문 제목은 \"arXiv\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 arxiv.org로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 benchmark, llm, claude, glm-5로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: arXiv — YC-Bench paper (https://arxiv.org/abs/2604.01212)"
        - "비교 출처 2: GitHub — YC-Bench repository (https://github.com/collinear-ai/yc-bench)"
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - "숫자 포인트: 원문에서 다시 본 숫자나 버전 표기는 1, 12, 4.6, 127 쪽이야."
    - type: adversarial
      result: pass
