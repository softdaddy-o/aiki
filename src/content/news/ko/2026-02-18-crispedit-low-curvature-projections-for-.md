...
factCheck:
  ...
  checks:
    - type: source_match
      ...
      items:
        - "기사 제목 대조: CrispEdit: 확장 가능한 비파괴 LLM 편집을 위한 저곡률 투영"
        - "원문 제목 대조: CrispEdit: Low-Curvature Projections for Scalable Non-Destructive LLM Editing"
        - "대표 출처 도메인: arxiv.org"
        - "핵심 태그 축: llm"
    - type: web_cross_check
      ...
      items:
        - "출처 1: cs.AI (https://arxiv.org/abs/2602.15823v1)"
        - "출처 2: Secondary source (https://arxiv.org/abs/2602.15785v1)"
    - type: number_verify
      result: pass
      summary: 숫자와 고유 명칭은 따로 빼서 한 번 더 보고 과장된 표현을 걸렀다.
      items:
        - "수치 대조: arXiv 논문 2602.15823v1의 추상 페이지: CrispEdit: 확장 가능한 비파괴 LLM 편집을 위한 저곡률 투영."
        - "수치 대조: arXiv 논문 2602.15823v1의 추상 페이지: CrispEdit: 확장 가능한 비파괴 LLM 편집을 위한 저곡률 투영 [원문](https://arxiv.org/abs/2602.1582..."
        - "수치 대조: 이 이슈는 arXiv 논문 2602.15823v1의 추상 페이지: CrispEdit: 확장 가능한 비파괴 LLM 편집을 위한 저곡률 투영가 실제 시장과 개발 흐름에서 왜 중요한지 빠르게 파악하..."
        - "수치 대조: CrispEdit: 확장 가능한 비파괴 LLM 편집을 위한 저곡률 투영, arXiv 논문 2602.15823v1의…에서 진짜 봐야 하는 건 이름 자체보다 실무 우선순위와 적용 범위가 어디를 바..."
    - type: adversarial
      result: pass
