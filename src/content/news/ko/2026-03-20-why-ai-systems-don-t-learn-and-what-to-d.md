  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "대표 출처 도메인: arxiv.org"
        - "핵심 태그 축: claude-code, memory, cursor, claude"
    ...
    - type: number_verify
      ...
      items:
        ...
        - "수치 대조: 이 이슈는 arXiv 논문 2603.15381의 초록 페이지: AI 시스템이 학습하지 않는 이유와 이에 대해 수행할 작업: 인지 과학의 자율 학습에 대한 교훈가 실제 시장과 개발 흐름에서 왜 ..."
