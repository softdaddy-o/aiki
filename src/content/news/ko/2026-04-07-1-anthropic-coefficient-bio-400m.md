  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - 제목부터 다시 보면 기사 제목은 "Anthropic, 바이오텍 Coefficient Bio를 4억 달러에 인수"이고, 원문 제목은 "TechCrunch"로 잡혔어.
        - 출처를 다시 보면 대표 원문 도메인은 techcrunch.com로 잡혔어.
        - 이 글의 축을 다시 보면 이 글의 핵심 축은 anthropic, biotech, acquisition, healthcare-ai로 읽었어.
    - type: web_cross_check
      ...
      items:
        ...
        - 같이 본 출처로는 TechCrunch — Anthropic buys Coefficient Bio (https://techcrunch.com/2026/04/03/anthropic-buys-biotech-startup-coefficient-bio-in-400m-deal-reports/)
        - 같이 본 출처로는 The Next Web — Anthropic acquires Coefficient Bio (https://thenextweb.com/news/anthropic-just-paid-400-million-for-a-startup-with-fewer-than-10-people)
        - 같이 본 출처로는 Anthropic — Claude for Life Sciences (https://www.anthropic.com/news/claude-for-life-sciences)
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - 숫자를 다시 보면 원문에서 다시 본 숫자나 버전 표기는 4, 10 쪽이야.
    - type: adversarial
      result: pass
...
단기 매출보다 더 중요한 건 레퍼런스야. “Claude가 연구실 안에서 실제 업무를 바꾼다”는 사례가 쌓이면, Anthropic의 엔터프라이즈 영업은 훨씬 쉬워져.
