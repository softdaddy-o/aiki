  ...
  checks:
    - type: source_match
      ...
      items:
        ...
        - "제목 대조: 기사 제목은 \"DeepSeek R1 공개, 오픈 추론 모델 경쟁 가속\"이고, 원문 제목은 \"DeepSeek R1\"로 잡혔어."
        - "출처 대조: 대표 원문 도메인은 api-docs.deepseek.com로 잡혔어."
        - "태그 대조: 이 글의 핵심 축은 deepseek-r1, reasoning, open-model로 읽었어."
    - type: web_cross_check
      ...
      items:
        ...
        - "비교 출처 1: DeepSeek R1 (https://api-docs.deepseek.com/news/news250120)"
        - "비교 출처 2: Secondary source (https://huggingface.co/deepseek-ai/DeepSeek-R1)"
    - type: number_verify
      result: pass
      summary: 헷갈리기 쉬운 숫자와 고유 명칭은 따로 떼어 한 번 더 봤다.
      items:
        - "숫자 포인트: 원문에서 다시 본 숫자나 버전 표기는 R1, OpenAI-o1 쪽이야."
