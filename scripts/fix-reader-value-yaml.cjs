...
const TARGETS = [
    {
        ...
        readerValue: '소형 멀티모달 추론 모델이 어디까지 올라왔는지, 그리고 Phi 계열이 실사용 후보로 얼마나 가까워졌는지 빠르게 판단하는 데 도움이 된다.',
    },
    {
        ...
        readerValue: '에이전트 메모리 설계가 단순 저장이 아니라 장기 작업 성능과 직결된다는 점을 빠르게 읽는 데 도움이 된다.',
    },
    {
        ...
        readerValue: '작은 모델도 확장 전략에 따라 경쟁력을 만들 수 있다는 신호를 빠르게 읽는 데 도움이 된다.',
    },
    {
        ...
        readerValue: '비디오와 시각 추론 평가가 결과 점수보다 과정 검증 쪽으로 이동하고 있다는 점을 빠르게 파악하는 데 도움이 된다.',
    },
    {
        ...
        readerValue: '프롬프트 설계 도구가 모델 성능 못지않게 실제 사용 경험과 생산성을 바꾸는 축이라는 점을 빠르게 읽는 데 도움이 된다.',
    },
];
