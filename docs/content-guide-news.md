...
| 순서 | 내용 | 길이 |
|------|------|------|
| 1문단 | 핵심 뉴스 — 무슨 일이 일어났나 | 2-3문장 |
| 2문단 | 왜 중요한가 — 실무/업계 맥락 | 2-4문장 |
| 3문단 | 실용적 시사점 — 독자에게 뭐가 달라지나 | 2-3문장 |
| (선택) 4문단 | 분석/전망 — 앞으로 어떻게 될까 | 2-3문장 |

### 길이

- 최소 300자, 최대 800자 (한국어 기준)
- 너무 길지 않게 — 네니엘은 짧은 글을 선호

### 본문 규칙

- h2/h3 섹션 헤더 사용 가능 (긴 기사일 때)
